...
import { HomeIcon, LibraryIcon, SearchIcon, PlusCircleIcon, RssIcon } from "@heroicons/react/outline"
    ...
    return (
        ...
        sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex">
           <div className="space-y-4">
               <button 
                className="flex items-center space-x-2 hover:text-white px-4 py-1 text-black bg-[#18d860] rounded-full"
                onClick={() => signOut()}
               >
                   <p>Log out</p>
               </button>
